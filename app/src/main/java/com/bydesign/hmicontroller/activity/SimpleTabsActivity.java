    ...
    public JSONObject makingTokenFromUsb(String usbData) {
        ...
        try {
            ...
            try {
                ...
                // object for post
//            ObjForPost.accumulate("values", jsonArray);
//            ObjForPost.accumulate("TimeStamp", currentTimeStamp);
//            ObjForPost.accumulate("Qcode", jsonObject1.get("QCode"));
//            ObjForPost.accumulate("DmMsg", jsonObject1.get("DM"));
//            ObjForPost.put("stackTemp", jsonObject1.get("Stack Temp"));
//            ObjForPost.put("O2", jsonObject1.get("O2"));
//
//            System.out.println(ObjForPost);

                obj.accumulate("ts", currentTimeStamp);
                ...
                if (ObjForRePost == null) {
                    ...
                    new HttpAsyncTaskUpdate().execute("http://" + databaseHandler.Get_Url() + "/smartcity/gassensor/update");
...
/*POST DATA STARTED*/
    ...
    public String Update(String url, String result, JSONArray arrayforPost) {
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost(url);
            String tok = result;
            System.out.print("token check inside update" + token1);
            String json = "";
...
//                    }
                ...
                * */
                ...
                new HttpAsyncTask().execute("http://" + databaseHandler.Get_Url() + "/smartcity/gassensor/update");
            }
        } catch (Exception e) {
            if (e.getLocalizedMessage().equalsIgnoreCase("Host name may not be null"))
    ...
    private class HttpAsyncTaskUpdate extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            return Update("http://" + databaseHandler.Get_Url() + "/smartcity/gassensor/update", tokenforupdate, arrayForPost);
        }
